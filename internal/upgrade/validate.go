...
// cross-instance equivalent of internal/shadowflow's own validate step,
// necessarily reimplemented rather than reused: internal/shadowflow's
...
//
// Deliberately a SIMPLER checksum than internal/shadowflow's own
...
// internal/shadowflow's own chunked approach — can't narrow a mismatch
// down to which specific ROWS differ, only that the table as a whole
// doesn't match. Bringing internal/shadowflow's own chunked technique
...
// order internal/catalog.ListColumns returned them from source).
