...
// and internal/catalog.ListSchemas already excludes them for the exact
...
// internal/catalog.ListColumns (the same introspection
// internal/shadowflow.createPartitionedShadowTable already established
...
// source INCLUDING ALL) the way internal/shadowflow's plain (non-
...
// internal/ddlflow/internal/shadowflow each already have; kept local
// rather than exported from one of those packages specifically because
// internal/upgrade has no other dependency on either (see the package
