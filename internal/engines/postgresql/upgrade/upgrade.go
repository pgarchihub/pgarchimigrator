...
// internal/engines/postgresql/shadowflow already uses for a single table, generalized
...
const (
	...
	// the DDL to recreate them on the target — internal/engines/postgresql/catalog.ListColumns,
	// generalized across a whole database rather than one table, the
	// same introspection internal/engines/postgresql/shadowflow.createPartitionedShadowTable
	...
	// generalization of internal/engines/postgresql/shadowflow's own initial sync + delta
