...
// cross-instance equivalent of internal/engines/postgresql/shadowflow's own validate step,
// necessarily reimplemented rather than reused: internal/engines/postgresql/shadowflow's
...
//
// Deliberately a SIMPLER checksum than internal/engines/postgresql/shadowflow's own
...
// internal/engines/postgresql/shadowflow's own chunked approach — can't narrow a mismatch
// down to which specific ROWS differ, only that the table as a whole
// doesn't match. Bringing internal/engines/postgresql/shadowflow's own chunked technique
...
// order internal/engines/postgresql/catalog.ListColumns returned them from source).
