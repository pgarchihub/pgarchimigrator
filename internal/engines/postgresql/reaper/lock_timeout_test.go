...
// The fast, DB-independent counterpart to internal/engines/postgresql/ddlflow's identical
// tests — internal/engines/postgresql/reaper duplicates the same execDDLWithLockTimeout /
