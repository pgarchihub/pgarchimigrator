...
// mirrors internal/engines/postgresql/progress.Report.Render's style for a consistent feel
...
func Generate(ctx context.Context, pool *pgxpool.Pool, tableStats orchestrator.TableStatsFetcher, req orchestrator.MigrationRequest) (*Report, error) {
	...
	report := &Report{
		...
		// internal/engines/postgresql/catalog; missed here until now.
		Statements: []string{},
		Warnings:   []string{},
		Notes:      []string{},
	}
...
// across internal/engines/postgresql/ddlflow, internal/engines/postgresql/reaper, internal/engines/postgresql/shadowflow; moving
