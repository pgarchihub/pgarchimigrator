...
// Transaction" risk — same rationale as internal/engines/postgresql/ddlflow's backfillLoop).
package shadowflow
...
// defaultInitialSyncBatchSize matches internal/engines/postgresql/ddlflow's default for
// consistency (Architecture Doc Section 8: "commit every 10k rows").
const defaultInitialSyncBatchSize = 10000

// initialSyncLockWaitBackoff mirrors internal/engines/postgresql/ddlflow's backoff constant.
...
type InitialSyncConfig struct {
	...
	// internal/engines/postgresql/ddlflow's backfillLoop already does for EXPAND_BACKFILL —
