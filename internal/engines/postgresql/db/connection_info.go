...
type ConnectionInfo struct {
	...
	// the same derivation internal/engines/postgresql/db's preflight check already used.
	PostgresVersion int
...
// silently exposed to internal/engines/postgresql/ddlflow's PG11+ "fast path ADD COLUMN"
// assumption not actually holding (see internal/engines/postgresql/ddlflow's own doc
...
// shared by internal/engines/postgresql/db's own preflight check (checkPostgresVersion),
