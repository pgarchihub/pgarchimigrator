...
const (
	...
	// see internal/engines/postgresql/ddlflow.executeAddIndex/executeDropIndex for why that
	...
	// internal/engines/postgresql/ddlflow.executeRenameColumn's doc comment for the full
	...
	// from the new one — see internal/engines/postgresql/ddlflow.executeRenameTable's doc
	...
	// See internal/engines/postgresql/ddlflow.executeAddForeignKey's doc comment for the
	...
	// expression is. See internal/engines/postgresql/ddlflow.executeAddGeneratedColumn's
	...
	// internal/engines/postgresql/shadowflow.prepare's own doc comment for the mechanism:
...
type ColumnChange struct {
	...
	// internal/engines/postgresql/ddlflow.defaultIndexName); for DROP_INDEX it is required —
	...
	// deliberate design choice so internal/engines/postgresql/ddlflow/internal/engines/postgresql/shadowflow
...
// useful: internal/engines/postgresql/shadowflow has no ADD_INDEX-specific logic anywhere,
