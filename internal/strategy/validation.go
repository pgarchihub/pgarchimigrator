...
// internal/orchestrator, and again at the point internal/engines/postgresql/ddlflow
...
// at all" (see internal/engines/postgresql/ddlflow.executeAddForeignKey for how an empty
// value is handled).
