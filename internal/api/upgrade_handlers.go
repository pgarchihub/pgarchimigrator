...
// background — the internal/upgrade analog of
...
// identically here (internal/upgrade.Flow has no "reset a FAILED job"
// operation either).
//
...
// endpoint only reads catalog metadata (internal/catalog.ListSchemas/
