...
func (m MigrationFile) ToMigrationRequest(actor string) (orchestrator.MigrationRequest, error) {
	...
	// before construction, so internal/orchestrator/internal/engines/postgresql/ddlflow/
	// internal/engines/postgresql/shadowflow only ever see the final, explicit bounds —
