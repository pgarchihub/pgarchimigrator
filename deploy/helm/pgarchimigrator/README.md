...
- `internal/engines/postgresql/reaper`'s orphan-cleanup and rollback-window sweeps rely
...
| `autoSweep` | `true` | Runs `internal/engines/postgresql/reaper`'s periodic loop in the background (`pgarchimigrator serve --auto-sweep`) |
