...
export const api = {
  ...
  // dropdowns) — see internal/engines/postgresql/catalog's package doc comment. ---
  ...
  // --- Upgrades (internal/engines/postgresql/upgrade — whole-database PostgreSQL
  ...
  // this does NOT wait for the operation to finish; internal/engines/postgresql/upgrade.Flow
