...
// server-side (see internal/engines/postgresql/progress.Compute's early-return path) purely
...
describe("MigrationDetail — does not crash on a null Statements field", () => {
  ...
  // internal/engines/postgresql/progress's pipelineFor and internal/engines/postgresql/ddlflow's
  ...
  // found and fixed once in internal/engines/postgresql/preview.Generate, then reintroduced
  // in internal/engines/postgresql/progress.describeOperation's SHADOW_TABLE/default
