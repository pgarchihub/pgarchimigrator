...
// Transaction" risk — same rationale as engines/postgresql/ddlflow's backfillLoop).
package shadowflow
...
// defaultInitialSyncBatchSize matches engines/postgresql/ddlflow's default for
// consistency (Architecture Doc Section 8: "commit every 10k rows").
const defaultInitialSyncBatchSize = 10000

// initialSyncLockWaitBackoff mirrors engines/postgresql/ddlflow's backoff constant.
...
type InitialSyncConfig struct {
	...
	// engines/postgresql/ddlflow's backfillLoop already does for EXPAND_BACKFILL —
