...
//	go test ./engines/postgresql/shadowflow/... -tags=integration -v -run TestExecute -timeout 60s
//	go test ./engines/postgresql/shadowflow/... -tags=integration -v -run TestRollback -timeout 60s
...
func TestExecute_EndToEnd_AlterColumnTypeSucceeds(t *testing.T) {
	...
	// engines/postgresql/ddlflow's Job.RowsProcessed.
...
// engines/postgresql/shadowflow.prepare's own doc comment for the mechanism this
