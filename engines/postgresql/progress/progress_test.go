...
// se — engines/postgresql/ddlflow.executeAddIndex already enforced index validity
...
// successful, deliberate user Rollback() and engines/postgresql/reaper's orphan
...
// (matching engines/postgresql/ddlflow's own quoteIdent-quoted identifier style).
...
// already found and fixed once in engines/postgresql/preview.Generate — this test
...
// TestGenerate_NeverReturnsNilSlices' approach in engines/postgresql/preview.
...
// pipeline — see engines/postgresql/shadowflow.prepare's own doc comment for why
