...
type ConnectionInfo struct {
	...
	// the same derivation engines/postgresql/db's preflight check already used.
	PostgresVersion int
...
// silently exposed to engines/postgresql/ddlflow's PG11+ "fast path ADD COLUMN"
// assumption not actually holding (see engines/postgresql/ddlflow's own doc
...
// shared by engines/postgresql/db's own preflight check (checkPostgresVersion),
