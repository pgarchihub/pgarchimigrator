...
//	go test ./engines/postgresql/upgrade/... -tags=integration -v -run TestFlow_Run -timeout 120s
...
// exact mechanism engines/postgresql/upgrade/sync.go's own doc comment argues
