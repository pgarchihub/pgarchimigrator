...
// and engines/postgresql/catalog.ListSchemas already excludes them for the exact
...
// engines/postgresql/catalog.ListColumns (the same introspection
// engines/postgresql/shadowflow.createPartitionedShadowTable already established
...
// source INCLUDING ALL) the way engines/postgresql/shadowflow's plain (non-
...
// engines/postgresql/ddlflow/engines/postgresql/shadowflow each already have; kept local
// rather than exported from one of those packages specifically because
// engines/postgresql/upgrade has no other dependency on either (see the package
